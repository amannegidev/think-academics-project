  ...
  return (
    <section className="px-4 bg-white">
      <div className="w-full mx-auto font-[helvetica]">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-5 uppercase">new Products</h2>
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between bg-gray-100">
                ...
                <button
                  ...
                  className="mt-4 w-full hidden md:block bg-[#FBA518] text-white py-2 rounded-md hover:bg-red-700 transition"
                >
                  Add to Cart
                </button>
              </div>
