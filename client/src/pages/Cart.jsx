...
const cart = () => {
    ...
    return (
   <Layout>
         <div className="flex flex-col md:flex-row justify-center py-16 max-w-full w-full px-6 mx-auto">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70 rounded-xl">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2 space-y-4">
                    ...
                    <select className="w-full border border-gray-300 bg-white px-3 py-4 rounded mt-2 outline-none">
                ...
                <div className="text-gray-500 mt-4 space-y-4">
